    ...
    var e = {
            ...
            widgetSection: function(i) {
                function a(t) {
                    ...
                    function r() {
                        C = i.offset().top, k = t(window).height(), T = i.outerHeight(!0), S = t(document).height() - (C + T), c = t("body").prop("clientWidth") + 17, s()
                    }

                    function s() {
                        if (!i.hasClass("wpr-sticky-section-yes") && !i.find(".wpr-sticky-section-yes-editor")) return void(P = "relative");
                        ...
                        r.forEach((e, t) => {
                            if (e[1] > c) {
                                ...
                                h = "desktop" == r ? i.data("settings") ? C + i.data("settings").wpr_sticky_effects_offset : C + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings") : i.data("settings") ? C + i.data("settings")["wpr_sticky_effects_offset_" + r] : C + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings"), -1 === f.indexOf(e[0]) ? (P = -1 === w ? .indexOf(e[0]) ? a[t - 1] ? a[t - 1] : d : "relative", a[t] = P) : -1 !== f.indexOf(e[0]) && (P = d)
                            }
                        });
                        var s = function() {
                            let e = g.scrollTop();
                            "fixed" != P && ("top" === l && (e > C ? n() : e <= C && i.css({
                                position: "relative"
                            })), "bottom" === l && (e + k <= t(document).height() - S ? n() : i.css({
                                position: "relative"
                            }))), "relative" !== P && (e > h ? "yes" == i.data("wpr-replace-header") ? "yes" === i.data("wpr-sticky-hide") ? (e >= C && i.addClass("wpr-visibility-hidden"), e < u && i.next().addClass(x).addClass("wpr-" + v + "-in")) : (i.addClass("wpr-visibility-hidden"), i.next().addClass(x).addClass("wpr-" + v + "-in")) : i.addClass("wpr-sticky-header") : e <= h && ("yes" == i.data("wpr-replace-header") ? (i.next().removeClass(x), i.removeClass("wpr-visibility-hidden"), i.next().removeClass("wpr-" + v + "-in")) : i.removeClass("wpr-sticky-header"))), "yes" === i.data("wpr-sticky-hide") && e >= C && (e < u ? "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + v + "-out"), i.next().addClass("wpr-" + v + "-in")) : (i.removeClass("wpr-" + v + "-out"), i.addClass("wpr-" + v + "-in")) : "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + v + "-in"), i.next().addClass("wpr-" + v + "-out")) : (i.removeClass("wpr-" + v + "-in"), i.addClass("wpr-" + v + "-out"))), clearTimeout(o), o = setTimeout(() => {
                                u = e
                            }, 10)
                        };
                        "sticky" == P ? t(window).scroll(s) : "fixed" == P && (n(), t(window).scroll(s)), "yes" == i.data("wpr-replace-header") && 0 != i.next().length && i.next().get(0).style.setProperty("--wpr-animation-duration", z);
                        let o
                    }

                    function n() {
                        var a = +window.innerHeight - (+i.css("top").slice(0, -2) + i.height()),
                            r = +window.innerHeight - (+i.css("bottom").slice(0, -2) + i.height());
                        "yes" === i.data("wpr-sticky-hide") && u < g.scrollTop() || ("" == _ && (_ = "fixed"), i.css({
                            position: _
                        }), t(".wpr-close-cart span").length && !e.editorCheck() && t(".wpr-close-cart span").trigger("click"))
                    }

                    function o() {
                        t("#wpadminbar").length && (j = t("#wpadminbar").css("height").slice(0, t("#wpadminbar").css("height").length - 2), "top" === l && "fixed" == i.css("position") && (i.css("top", +j + O + "px"), i.css("bottom", "auto")))
                    }
                    var d = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-type") : i.attr("data-wpr-position-type"),
                        l = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-location") : i.attr("data-wpr-position-location"),
                        p = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-offset") : i.attr("data-wpr-position-offset"),
                        c = t("body").prop("clientWidth") + 17,
                        f = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-devices") : i.attr("data-wpr-sticky-devices"),
                        w = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-active-breakpoints") : i.attr("data-wpr-active-breakpoints"),
                        m = !!(i.hasClass("wpr-sticky-section-yes") || i.find(".wpr-sticky-section-yes-editor")),
                        h = t(window).scrollTop(),
                        g = t(window),
                        u = g.scrollTop(),
                        y = "",
                        v = "none",
                        b = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-z-index") : i.attr("data-wpr-z-index"),
                        _ = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-type") : i.attr("data-wpr-sticky-type"),
                        x = i.next().hasClass("e-con") ? "wpr-hidden-header-flex" : "wpr-hidden-header",
                        C = i.offset().top,
                        k = t(window).height(),
                        T = i.outerHeight(!0),
                        S = t(document).height() - (C + T),
                        P, j;
                    v = i.data("settings") && i.data("settings").sticky_animation ? i.data("settings").sticky_animation : i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-animation");
                    var z = i.attr("data-wpr-animation-duration") ? i.attr("data-wpr-animation-duration") + "s" : "500s";
                    if (0 < i.closest("div[data-elementor-type=\"wp-post\"]").length ? y = i.closest("div[data-elementor-type=\"wp-post\"]") : 0 < i.closest("div[data-elementor-type=\"header\"]").length ? y = i.closest("div[data-elementor-type=\"header\"]") : 0 < i.closest("div[data-elementor-type=\"footer\"]").length && (y = i.closest("div[data-elementor-type=\"footer\"]")), i.find(".wpr-sticky-section-yes-editor").length || (d = i.attr("data-wpr-position-type"), l = i.attr("data-wpr-position-location"), p = i.attr("data-wpr-position-offset"), f = i.attr("data-wpr-sticky-devices"), w = i.attr("data-wpr-active-breakpoints"), b = i.attr("data-wpr-z-index")), "top" === l && "auto" === i.css("top")) {
                        var O = 0;
                        i.css("top", 0)
                    } else var O = +i.css("top").slice(0, -2);
                    if (0 == f.length && (d = "relative"), e.editorCheck() && f) {
                        var I = i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-devices");
                        i.attr("data-wpr-sticky-devices", I), f = i.attr("data-wpr-sticky-devices")
                    }
                    if (s(), o(), t(window).smartresize(function() {
                            r()
                        }), !e.editorCheck() && "yes" !== i.data("wpr-replace-header")) {
                        const e = a(function(e) {
                                for (let i of e) "childList" === i.type && (t(window).trigger("scroll"), r())
                            }, 100),
            ...
            widgetMegaMenu: function(i) {
                ...
                function n(e) {
                    ...
                    e.closest(".wpr-mobile-mega-menu").addClass("wpr-mobile-sub-offcanvas-open"), 0 < e.find(".wpr-menu-offcanvas-back").find("h3").length ? e.find(".wpr-menu-offcanvas-back").find("h3").text(a) : e.find(".wpr-menu-offcanvas-back").append("<h3></h3>").find("h3").text(a);
            ...
            widgetOnepageNav: function(e) {
                t(document).ready(function() {
                    ...
                    i.each(function() {
                        -1 !== o.indexOf(t(this).find("a").attr("href")) && t(this).addClass("wpr-onepage-active-item")
                    }), i.each(function() {
                        t(this).click(function(e) {
                            ...
                            var s = t(this).find("a").attr("href"),
                                ...
                                o = n.offset().top;
                            t("html, body").animate({
                                scrollTop: "yes" === r && t("[data-wpr-sticky-section=\"yes\"]").first().length ? o - t("[data-wpr-sticky-section=\"yes\"]").first().height() : o
                            }, a)
                        })
            ...
            widgetGrid: function(a) {
                ...
                function s() {
                    ...
                    "yes" !== u.find(".wpr-grid-media-wrap").attr("data-overlay-link") || e.editorCheck() || (u.find(".wpr-grid-media-wrap").css("cursor", "pointer"), u.find(".wpr-grid-media-wrap").on("click", function(e) {
                        ...
                        if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-grid-media-hover")) {
                            ...
                            if (a) try {
                                ...
                                if (["http:", "https:"].includes(r.protocol)) {
                                    var s = r.href;
                                    "_blank" === u.find(".wpr-grid-item-title a").attr("target") ? window.open(s, "_blank").focus() : window.location.href = s
                ...
                function n(i) {
                    if (-1 !== a.find(".wpr-grid-item-lightbox").length) {
                        ...
                        r.each(function() {
                            ...
                            u.hasClass("wpr-media-grid") || i.find(".wpr-grid-image-wrap").attr("data-src", e);
                        ...
                        }), u.lightGallery(i.lightbox), u.on("onAfterOpen.lg", function() {
                ...
                function d(e, r = "") {
                    var s = a.find(".wpr-grid"),
                        ...
                        q, L, E, W, l;
                    "" != r && (n = r);
                    for (var B = a.attr("class"), B = B.split(" "), M = 0; M < B.length - 1; M++) - 1 !== B[M].search(/mobile\d/) && (m = B[M].slice(-1)), -1 !== B[M].search(/mobile_extra\d/) && (q = B[M].slice(-1)), -1 !== B[M].search(/tablet\d/) && (h = B[M].slice(-1)), -1 !== B[M].search(/tablet_extra\d/) && (L = B[M].slice(-1)), -1 !== B[M].search(/widescreen\d/) && (W = B[M].slice(-1)), -1 !== B[M].search(/laptop\d/) && (E = B[M].slice(-1));
                    ...
                    R >= A && null != G.mobile ? (w = m, u = v, y = b) : V >= A && null != G.mobile_extra ? (w = q ? q : h, u = _, y = x) : N >= A && null != G.tablet ? (w = h, u = C, y = k) : H >= A && null != G.tablet_extra ? (w = L ? L : h, u = T, y = S) : U >= A && null != G.laptop ? (w = E ? E : g, u = z, y = O) : F > A ? (w = g, u = e.gutter_hr, y = e.gutter_vr) : (w = W ? W : g, u = P, y = j), 8 < w && (w = 8), "string" == typeof w && -1 !== w.indexOf("pro") && (w = 3), I = s.width() + u - .3, n.outerWidth(Math.floor(I / w - u)), n.css("margin-bottom", y + "px"), 1 === w && n.last().css("margin-bottom", "0");
                    var X = -1;
                    if (o.each(function() {
                            var e = t(this).outerHeight(),
                                i = parseInt(t(this).css("top"), 10);
                            i > X && (X = i)
                        }), "fitRows" === d && o.each(function() {
                            parseInt(t(this).css("top")) === X && t(this).addClass("rf-last-row")
                        }), "list" === d) {
                        var Y = n.find(".wpr-grid-image-wrap").outerHeight();
                        if (n.find(".wpr-grid-item-below-content").css("min-height", Y + "px"), 480 > t("body").prop("clientWidth")) n.find(".wpr-grid-media-wrap").css({
                            float: "none",
                            width: "100%"
                        }), n.find(".wpr-grid-item-below-content").css({
                            float: "none",
                            width: "100%"
                        }), n.find(".wpr-grid-image-wrap").css("padding", "0"), n.find(".wpr-grid-item-below-content").css("min-height", "0"), "zigzag" === p && n.find("[class*=\"elementor-repeater-item\"]").css("text-align", "center");
                        else if ("zigzag" !== p) {
                            n.find(".wpr-grid-media-wrap").css({
                                float: p,
                                width: c + "%"
                            });
                            var J = "left" === p ? "margin-right" : "margin-left";
                            n.find(".wpr-grid-media-wrap").css(J, f + "px"), n.find(".wpr-grid-item-below-content").css({
                                float: p,
                                width: "calc((100% - " + c + "%) - " + f + "px)"
                            })
                        } else n.filter(":even").find(".wpr-grid-media-wrap").css({
                            float: "left",
                            width: c + "%"
                        }), n.filter(":even").find(".wpr-grid-item-below-content").css({
                            float: "left",
                            width: "calc((100% - " + c + "%) - " + f + "px)"
                        }), n.filter(":even").find(".wpr-grid-media-wrap").css("margin-right", f + "px"), n.filter(":odd").find(".wpr-grid-media-wrap").css({
                            float: "right",
                            width: c + "%"
                        }), n.filter(":odd").find(".wpr-grid-item-below-content").css({
                            float: "right",
                            width: "calc((100% - " + c + "%) - " + f + "px)"
                        }), n.filter(":odd").find(".wpr-grid-media-wrap").css("margin-left", f + "px"), s.hasClass("wpr-grid-list-ready") || n.each(function(e) {
                            ...
                            s.hasClass("wpr-grid-list-ready") || s.addClass("wpr-grid-list-ready")
                        }, 500)
                    }
                    l = d, "list" === d && (d = "fitRows"), "default" !== e.filters_animation && (D = 0);
                    s.isotopewpr({
                        layoutMode: d,
                        masonry: {
                            gutter: u
                    ...
                    if ("yes" === e.filters_count && a.find(".wpr-grid-filters a, .wpr-grid-filters span").each(function() {
                            ...
                            if (e.grid_settings && "load" == i) {
                                var n = "*" === t(this).attr("data-filter") ? "*" : t(this).data("ajax-filter")[0],
                                    o = "*" === t(this).attr("data-filter") ? "*" : t(this).data("ajax-filter")[1];
                                let i = {
                                    action: y,
                                ...
                                t.ajax({
                                    ...
                                    data: i,
                                    success: function(e) {
                                        s = e.data.query_found, r.find("sup").text(e.data.query_found)
                                    },
                                    error: function(e) {
                                        console.log(e)
                                    }
                                })
                            } else "*" === t(this).attr("data-filter") ? t(this).find("sup").text(a.find(".wpr-grid-filters").next().find("article").length) : t(this).find("sup").text(a.find(t(this).attr("data-filter")).length)
                        ...
                        if ("yes" === e.deeplinking) {
                            ...
                            var s = a.find(".wpr-grid-filters span[data-filter=\"" + r + "\"]:not(.wpr-back-filter)"),
                                o = s.parent();
                            "parent" === s.parent().attr("data-role") ? o.parent("ul").find("ul[data-parent=\"" + r + "\"]").length && (o.parent("ul").children("li").css("display", "none"), o.siblings("ul[data-parent=\"" + r + "\"]").css("display", "block")) : "sub" === s.parent().attr("data-role") && (o.closest(".wpr-grid-filters").children("li").css("display", "none"), o.parent("ul").css("display", "inline-block")), a.find(".wpr-grid-filters span").removeClass("wpr-active-filter"), s.addClass("wpr-active-filter"), a.find(".wpr-grid").isotopewpr({
                                filter: r
                            }), e.lightbox.selector = "*" === r ? " .wpr-grid-image-wrap" : r + " .wpr-grid-image-wrap", n(e)
                        }
                        "yes" !== e.filters_hide_empty || e.grid_settings || a.find(".wpr-grid-filters span").each(function() {
                            var e = t(this).attr("data-filter");
                            "*" !== e && (0 === u.find(e).length ? t(this).parent("li").addClass("wpr-hidden-element") : t(this).parent("li").removeClass("wpr-hidden-element"))
                        ...
                        }, 100), e.grid_settings || a.find(".wpr-grid-filters span").on("click", function() {
                            A = 0;
                            ...
                            "infinite-scroll" === e.pagination_type && 0 === u.find(t(this).attr("data-filter")).length && a.find(".wpr-grid").infiniteScroll("loadNextPage"), "load-more" === e.pagination_type && 0 === u.find(t(this).attr("data-filter")).length && a.find(".wpr-grid").infiniteScroll("loadNextPage"), "default" !== e.filters_animation && a.find(".wpr-grid-item-inner").css({
                                opacity: "0",
                                transition: "none"
                                ...
                                filter: i
                            }), e.lightbox.selector = "*" === i ? " .wpr-grid-image-wrap" : i + " .wpr-grid-image-wrap", u.data("lightGallery").destroy(!0), u.lightGallery(e.lightbox)
                        })
                    }
                }
                ...
                function f() {
                    var e;
                    if (u.find(".wpr-wishlist-add").length && (t.ajax({
                            url: WprConfig.ajaxurl,
                            type: "POST",
                            data: {
                ...
                function w() {
                    u.find(".wpr-compare-add").length && (a.find(".wpr-compare-add").click(function(i) {
                        i.preventDefault();
                        var r = t(this),
                ...
                function m() {
                    let r = !1;
                    u.find(".wpr-wishlist-add").length && (a.find(".wpr-wishlist-add").click(function(i) {
                        i.preventDefault();
                        var s = t(this),
                            ...
                            success: function(i) {
                                ...
                                e = t.ajax({
                                    ...
                                    data: {
                                        action: v,
                                        nonce: WprConfig.nonce,
                                        wpr_item_length: +_.grid_settings.query_offset + a.find(".wpr-grid-item").length,
                                        wpr_filter: c,
                                        wpr_taxonomy: p,
                                        grid_settings: _.grid_settings
                                    },
                ...
                function g() {
                    a.find(".wpr-load-more-btn").on("click", function(e) {
                        e.preventDefault();
                        var i, o;
                        a.find(".wpr-active-filter").length && "*" !== a.find(".wpr-active-filter").data("filter") ? (i = a.find(".wpr-active-filter").data("ajax-filter")[0], o = a.find(".wpr-active-filter").data("ajax-filter")[1]) : (i = "*", o = "*"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation();
                        t(window).scrollTop();
                        D.find(".wpr-load-more-btn").hide(), D.find(".wpr-pagination-loading").css("display", "inline-block"), t.ajax({
                            type: "POST",
                            url: WprConfig.ajaxurl,
                            data: {
                                action: y,
                                nonce: WprConfig.nonce,
                                wpr_offset: +_.grid_settings.query_offset + a.find(".wpr-grid-item").length,
                                wpr_filter: o,
                                wpr_taxonomy: i,
                                grid_settings: _.grid_settings
                            },
                            success: function(e) {
                                ...
                                t.ajax({
                                    ...
                                    success: function(e) {
                                        I++;
                                        var i = t(e);
                                        u.infiniteScroll("appendItems", i), u.isotopewpr("appended", i), i.imagesLoaded().progress(function() {
                                            d(_), setTimeout(function() {
                                                d(_)
                                            }, 100), setTimeout(function() {
                                                u.addClass("grid-images-loaded")
                                            }, 500)
                                        }), D.find(".wpr-pagination-loading").hide(), 1 < l ? "load-more" === _.pagination_type && D.find(".wpr-load-more-btn").fadeIn() : (D.find(".wpr-pagination-finish").fadeIn(1e3), D.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                            D.find(".wpr-pagination-loading").hide()
                                        }, 500)), n(_), u.data("lightGallery").destroy(!0), u.lightGallery(_.lightbox), s(), r(), p(), window.dispatchEvent(new Event("resize")), window.dispatchEvent(new Event("scroll")), t(window).trigger("scroll")
                                    },
                                    error: function(e) {
                                        console.log(e)
                                    }
                ...
                var u = a.find(".wpr-grid"),
                    y = a.hasClass("elementor-widget-wpr-woo-grid") ? "wpr_get_woo_filtered_count" : a.hasClass("elementor-widget-wpr-media-grid") ? "wpr_get_media_filtered_count" : "wpr_get_filtered_count",
                    v = a.hasClass("elementor-widget-wpr-woo-grid") ? "wpr_filter_woo_products" : a.hasClass("elementor-widget-wpr-media-grid") ? "wpr_filter_grid_media" : "wpr_filter_grid_posts",
                    b;
                if (u.length) {
                    ...
                    if ("undefined" != typeof _ && !1 !== _) {
                        if (_ = JSON.parse(u.attr("data-settings")), a.find(".woocommerce-result-count").length) {
                            var C = a.find(".woocommerce-result-count").text(),
                                k = _.query_posts_per_page ? +_.query_posts_per_page : +WprConfig.woo_shop_ppp;
                            if (WprConfig.is_product_category ? k = +WprConfig.woo_shop_cat_ppp : WprConfig.is_product_tag && (k = +WprConfig.woo_shop_tag_ppp), isNaN(k) || 0 >= k) return;
                            var T = 1,
                            ...
                            var z = (T - 1) * k + 1,
                                O = Math.min(z + k - 1, j);
                            C = C.replace(/\d+\u2013\d+/, z + "\u2013" + O), a.find(".woocommerce-result-count").text(C)
                        }
                        if (d(_), setTimeout(function() {
                                d(_)
                        ...
                        c(_);
                        var A = 0;
                        if (u.on("arrangeComplete", function(e, i) {
                                var r = 0,
                                    s = 0,
                                    n = 0,
                                ...
                                else if (u.css("opacity", "1"), "default" === _.animation && "default" === _.filters_animation) return;
                                for (var l in i) {
                                    (0 == A || l > A - 1) && (n += _.animation_delay, a.find(i[l].element).find(".wpr-grid-item-inner").css({
                                        opacity: "1",
                                        top: "0",
                                        transform: "scale(1)",
                                        transition: "all " + o + "s ease-in " + n + "s"
                                    })), s += _.filters_animation_delay, u.hasClass("grid-images-loaded") && a.find(i[l].element).find(".wpr-grid-item-inner").css({
                                    ...
                                    0 <= p.indexOf("#filter:") && 0 > p.indexOf("#filter:*") && (p = p.replace("#filter:", ""), a.find(i[l].element).filter(function() {
                                        if (t(this).hasClass(p)) return r += _.filters_animation_delay, t(this)
                                ...
                                "1" !== u.css("opacity") && u.css("opacity", "1"), setTimeout(function() {
                                    u.addClass("grid-images-loaded")
                                }, 500), l(_)
                            }), "load-more" === _.pagination_type || "infinite-scroll" === _.pagination_type)
                            if (a.find(".wpr-grid-pagination").length && !e.editorCheck()) {
                                var D = a.find(".wpr-grid-pagination"),
                                    q = ".elementor-element-" + a.attr("data-id"),
                                    L = !1,
                                    E = !1;
                                "infinite-scroll" === _.pagination_type && (E = 300, L = q + " .wpr-load-more-btn"), u.infiniteScroll({
                                    ...
                                    D.find(".wpr-load-more-btn").hide(), D.find(".wpr-pagination-loading").css("display", "inline-block")
                                });
                                var W = 0;
                                u.on("load.infiniteScroll", function(e, i) {
                                    ...
                                    if (u.infiniteScroll("appendItems", o), u.isotopewpr("appended", o), o.imagesLoaded().progress(function() {
                                            d(_), setTimeout(function() {
                                                d(_), c(_)
                                            }, 10), setTimeout(function() {
                                                u.addClass("grid-images-loaded")
                                            }, 500)
                                        }), D.find(".wpr-pagination-loading").hide(), _.pagination_max_pages - 1 === W) D.find(".wpr-pagination-finish").fadeIn(1e3), D.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                        D.find(".wpr-pagination-loading").hide()
                                    }, 500);
                                    else if ("load-more" === _.pagination_type && (D.find(".wpr-load-more-btn").fadeIn(), a.find(".wpr-grid-filters").length && "*" !== a.find(".wpr-active-filter").attr("data-filter") && 0 < a.find(".wpr-active-filter").length)) {
                                        let e = a.find(".wpr-active-filter").attr("data-filter").substring(1);
                                        o.each(function() {
                                            return t(this).hasClass(e) ? (b = !0, !1) : void(b = !1)
                                        }), b || a.find(".wpr-grid").infiniteScroll("loadNextPage")
                                    }
                                    n(_), u.data("lightGallery").destroy(!0), u.lightGallery(_.lightbox), s(), r(), p(), setTimeout(function() {
                        ...
                        u.animate({
                            opacity: "1"
                        }, 1e3), _ = JSON.parse(u.attr("data-slick"));
                        var B = a.attr("class"),
                            M = B.match(/wpr-grid-slider-columns-\d/) ? +B.match(/wpr-grid-slider-columns-\d/).join().slice(-1) : 2,
                            R = B.match(/columns--widescreen\d/) ? +B.match(/columns--widescreen\d/).join().slice(-1) : M,
                            V = B.match(/columns--laptop\d/) ? +B.match(/columns--laptop\d/).join().slice(-1) : M,
                            N = B.match(/columns--tablet\d/) ? +B.match(/columns--tablet\d/).join().slice(-1) : 2,
                            H = B.match(/columns--tablet_extra\d/) ? +B.match(/columns--tablet_extra\d/).join().slice(-1) : N,
                            U = B.match(/columns--mobile_extra\d/) ? +B.match(/columns--mobile_extra\d/).join().slice(-1) : N,
                            F = B.match(/columns--mobile\d/) ? +B.match(/columns--mobile\d/).join().slice(-1) : 1,
                            G = _.sliderRows,
                        ...
                        u.slick({
                            ...
                            responsive: [{
                                ...
                                settings: {
                                    slidesToShow: R,
                                    slidesToScroll: X > R ? 1 : X
                                }
                            }, {
                                breakpoint: 2399,
                                settings: {
                                    slidesToShow: M,
                                    slidesToScroll: X > M ? 1 : X
                                }
                            }, {
                                breakpoint: 1221,
                                settings: {
                                    slidesToShow: V,
                                    slidesToScroll: X > V ? 1 : X
                                }
                            }, {
                                breakpoint: 1200,
                                settings: {
                                    slidesToShow: H,
                                    slidesToScroll: X > H ? 1 : X
                                }
                            }, {
                                breakpoint: 1024,
                                settings: {
                                    slidesToShow: N,
                                    slidesToScroll: X > N ? 1 : X
                                }
                            }, {
                                breakpoint: 880,
                                settings: {
                                    slidesToShow: U,
                                    slidesToScroll: X > U ? 1 : X
                                }
                            }, {
                                breakpoint: 768,
                                settings: {
                                    slidesToShow: F,
                                    slidesToScroll: X > F ? 1 : X
                                }
                            }]
                        });
                        ...
                        if (0 < Y.length && 0 < J.length) {
                            ...
                            0 < $ && (t(window).on("load", function() {
                                t(window).width() <= a.outerWidth() + Y.outerWidth() + J.outerWidth() + $ && (Y.addClass("wpr-adjust-slider-prev-arrow"), J.addClass("wpr-adjust-slider-next-arrow"))
                            }), t(window).smartresize(function() {
                                t(window).width() <= a.outerWidth() + Y.outerWidth() + J.outerWidth() + $ ? (Y.addClass("wpr-adjust-slider-prev-arrow"), J.addClass("wpr-adjust-slider-next-arrow")) : (Y.removeClass("wpr-adjust-slider-prev-arrow"), J.removeClass("wpr-adjust-slider-next-arrow"))
                            }))
                        }
                        if (a.find(".slick-dots").length && a.hasClass("wpr-grid-slider-dots-horizontal")) {
                            var Q = a.find(".slick-dots li").outerWidth() * a.find(".slick-dots li").length - parseInt(a.find(".slick-dots li span").css("margin-right"), 10);
                            a.find(".slick-dots").length && a.find(".slick-dots").css("width", Q), t(window).smartresize(function() {
                                setTimeout(function() {
                    ...
                    if (Z.observe(a[0], {
                        ...
                        var K = u.find(".wpr-grid-item-add-to-cart").find("i"),
                            ee = K.attr("class");
                        K.length && (ee = ee.substring(ee.indexOf("fa-"), ee.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            K.length && (s.find("i").removeClass(ee).addClass("fa-check"), setTimeout(function() {
                                s.find("i").removeClass("fa-check").addClass(ee)
                            }, 3500))
                        })
                    }
                    r(), s(), a.hasClass("elementor-widget-wpr-woo-category-grid-pro") || a.hasClass("elementor-widget-wpr-category-grid-pro") || n(_), o(_), p()
                }
            },
            ...
            widgetCountDown: function(i) {
                ...
                function r() {
                    ...
                    if (!e.editorCheck()) {
                        if (a.hasOwnProperty("hide-timer") && n.hide(), a.hasOwnProperty("hide-element") && t(a["hide-element"]).hide(), a.hasOwnProperty("message") && !i.children(".elementor-widget-container").children(".wpr-countdown-message").length && !i.children(".wpr-countdown-message").length) {
                            var r = s(a.message);
                            n.after("<div class=\"wpr-countdown-message\">" + r + "</div>")
                        }
                        if (a.hasOwnProperty("redirect")) {
                            var o = new URL(a.redirect);
                            ["http:", "https:"].includes(o.protocol) && (window.location.href = o.href)
                        }
                ...
                function s(e) {
                    ...
                    for (var r = t.getElementsByTagName("*"), s = 0, n; s < r.length; s++) {
                        n = r[s].attributes;
                        for (var o = n.length - 1, d; 0 <= o; o--)
                            if (d = n[o].name, "on" === d.substring(0, 2) && r[s].removeAttribute(d), "href" === d || "src" === d) {
                                var l = n[o].value;
                                0 === l.toLowerCase().indexOf("javascript:") && r[s].removeAttribute(d)
                            }
                    }
                    return t.innerHTML
                }
                var n = 0 < i.children(".elementor-widget-container").children(".wpr-countdown-wrap").length ? i.children(".elementor-widget-container").children(".wpr-countdown-wrap") : i.children(".wpr-countdown-wrap"),
                    o = null,
                    d = n.data("interval"),
                    l = n.data("show-again"),
                    p = new Date(1e3 * d);
                if ("evergreen" === n.data("type")) {
                    ...
                    p = w.hasOwnProperty(f) ? 0 === Object.keys(w).length || d !== w[f].interval ? c.setSeconds(c.getSeconds() + d) : w[f].endTime : c.setSeconds(c.getSeconds() + d), p + l < c.setSeconds(c.getSeconds()) && (p = c.setSeconds(c.getSeconds() + d)), w[f] = {
                        interval: d,
                        endTime: p
            ...
            widgetGoogleMaps: function(e) {
                ...
                if (1 < o.length ? (p.fitBounds(l), google.maps.event.addListenerOnce(p, "bounds_changed", function() {
                        s.zoom_depth && p.setZoom(parseInt(s.zoom_depth))
                    })) : p.setCenter(l.getCenter()), "yes" === s.cluster_markers) new MarkerClusterer(p, d, {
            ...
            widgetAdvancedSlider: function(e) {
                ...
                function a() {
                    n.find(".slick-current").each(function() {
                        ...
                        if (1 !== t(this).find(".wpr-slider-video").length && "yes" === r) {
                            ...
                            t(this).find(".wpr-slider-content") && "yes" === n.data("hide-video-content") && t(this).find(".wpr-slider-content").fadeOut(300)
                        }
                    })
                }

                function r() {
                    1 == c && n.find(".wpr-slider-item").not(".slick-active").find(".wpr-slider-animation").removeClass("wpr-animation-enter")
                }

                function s() {
                    n.find(".slick-active").find(".wpr-slider-content").fadeIn(0), n.find(".slick-cloned").find(".wpr-slider-content").fadeIn(0), n.find(".slick-current").find(".wpr-slider-content").fadeIn(0), 1 == c && n.find(".slick-active").find(".wpr-slider-animation").addClass("wpr-animation-enter")
                }
                var n = e.find(".wpr-advanced-slider"),
                    ...
                    l = "false",
                    p = e.attr("class"),
                    c = p.match(/wpr-adv-slider-columns-\d/) ? +p.match(/wpr-adv-slider-columns-\d/).join().slice(-1) : 2,
                    f = p.match(/columns--widescreen\d/) ? +p.match(/columns--widescreen\d/).join().slice(-1) : c,
                    w = p.match(/columns--laptop\d/) ? +p.match(/columns--laptop\d/).join().slice(-1) : c,
                    m = p.match(/columns--tablet\d/) ? +p.match(/columns--tablet\d/).join().slice(-1) : 2,
                    h = p.match(/columns--tablet_extra\d/) ? +p.match(/columns--tablet_extra\d/).join().slice(-1) : m,
                    g = p.match(/columns--mobile_extra\d/) ? +p.match(/columns--mobile_extra\d/).join().slice(-1) : m,
                    u = p.match(/columns--mobile\d/) ? +p.match(/columns--mobile\d/).join().slice(-1) : 1,
                    y = +p.match(/wpr-adv-slides-to-scroll-\d/).join().slice(-1),
                ...
                if (n.slick({
                        ...
                        var a = t(this).closest(".slick-slide"),
                            ...
                            s = t(this),
                            o = "";
                        if (l = "true" == l ? "false" : "true", r.includes("youtube")) r += "&autoplay=1", o = "allowfullscreen=\"allowfullscreen\"";
                            ...
                            return void(1 === a.find(".wpr-slider-video").length ? "true" == l ? (a.find("video")[0].play(), s.find("i").removeClass("fa-play").addClass("fa-pause")) : (a.find("video")[0].pause(), s.find("i").removeClass("fa-pause").addClass("fa-play")) : (a.find(".wpr-cv-container").prepend("<div class=\"wpr-slider-video wpr-custom-video\"><video " + c + " " + d + " " + p + " src=\"" + r + "\" width=\"100%\" height=\"100%\"></video></div>"), n.find("video").attr("width", e.find(".wpr-slider-item").width()), n.find("video").attr("height", e.find(".wpr-slider-item").height()), "yes" === n.data("hide-video-content") ? a.find(".wpr-slider-content").fadeOut(300) : "true" == l ? s.find("i").removeClass("fa-play").addClass("fa-pause") : s.find("i").removeClass("fa-pause").addClass("fa-play"), a.find("video")[0].play()))
                        }
                        1 !== a.find(".wpr-slider-video").length && (a.find(".wpr-cv-container").prepend("<div class=\"wpr-slider-video\"><iframe src=\"" + r + "\" width=\"100%\" height=\"100%\"  frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture;\"" + o + "></iframe></div>"), i(), "yes" === n.data("hide-video-content") && a.find(".wpr-slider-content").fadeOut(300))
                    }), n.on({
                        beforeChange: function() {
                            n.find(".wpr-slider-item").not(".slick-active").find(".wpr-slider-video").remove(), n.find(".wpr-animation-enter").find(".wpr-slider-content").fadeOut(300), "yes" !== n.data("hide-video-content") && (n.find(".wpr-slider-video-btn").find("i").removeClass("fa-pause").addClass("fa-play"), l = "false"), r()
                        },
                        afterChange: function() {
                            s(), a(), e.find(".slick-slide").removeClass("wpr-slick-visible"), e.find(".slick-current").addClass("wpr-slick-visible"), e.find(".slick-current").nextAll().slice(0, c - 1).addClass("wpr-slick-visible"), e.find(".wpr-advanced-slider").css("height", e.find(".slick-current").outerHeight())
                        }
                    ...
                    0 < i.find(".wpr-category-select").length && !d && ("product" == i.find(".wpr-search-form-input").attr("wpr-query-type") ? d = "product_cat" : d = "category"), s = setTimeout(() => {
                        ...
                        t.ajax({
                            ...
                            data: {
                                ...
                                wpr_show_product_price: i.find(".wpr-search-form-input").attr("show-product-price"),
                                ...
                                wpr_show_attachments: i.find(".wpr-search-form-input").attr("attachments")
                            },
                            success: function(e) {
            ...
            widgetAdvancedText: function(e) {
                ...
                function s(e) {
                    e.each(function() {
                        ...
                        }, b), e.hasClass("wpr-anim-text-type-rotate-1") && i.find("b").each(function() {
            ...
            widgetPostsTimeline: function(i) {
                ...
                if (i.find(".swiper-wrapper").length) {
                    var y = function(e, t) {
                        ...
                        v = i.find(".wpr-horizontal-bottom").length ? ".wpr-horizontal-bottom" : ".wpr-horizontal",
                        b = i.find(v + ".swiper"),
            ...
            widgetAdvancedAccordion: function(i) {
                var a = i.find(".wpr-acc-button"),
                    ...
                    l = 1e3 * +i.find(".wpr-advanced-accordion").data("interaction-speed"),
                    p = i.attr("data-id"),
                    c = window.location.href.indexOf("active_panel="); - 1 < c && (o = +window.location.href.substring(c, window.location.href.lastIndexOf("#")).replace("active_panel=", "") - 1), "click" === d ? ("accordion" == n ? a.off("click").on("click", function(r) {
                    r.preventDefault(), r.stopPropagation();
                    var e = a.index(this);
                    a.each(function(i) {
                        i != e && t(this).closest(".elementor-widget-wpr-advanced-accordion").attr("data-id") == p ? t(this).removeClass("wpr-acc-active") : ""
                    }), i.find(".wpr-acc-panel").each(function(i) {
                        i != e && t(this).closest(".elementor-widget-wpr-advanced-accordion").attr("data-id") == p ? t(this).removeClass("wpr-acc-panel-active") && t(this).slideUp(l) : ""
                ...
                }), a && -1 < o && a.eq(o).trigger("click")) : "hover" == d && (s.on("mouseenter", function() {
                    var e = s.index(this);
                    t(this).find(".wpr-acc-button").addClass("wpr-acc-active");
                    var i = t(this).find(".wpr-acc-panel");
                    i.slideDown(l), i.addClass("wpr-acc-panel-active"), s.each(function(i) {
                        if (i != e) {
                ...
                }), s && -1 < o && s.eq(o).trigger("mouseenter")), i.find(".wpr-acc-search-input").on({
                    focus: function() {
                ...
                i.find("i.fa-times").on("click", function() {
                    i.find(".wpr-acc-search-input").val(""), i.find(".wpr-acc-search-input").trigger("keyup")
                });
                ...
                w.each(function() {
                    ...
                    setTimeout(() => {
                        let e = t(this).val();
                        0 < e.length ? (i.find(".wpr-acc-search-input-wrap").find("i.fa-times").css("display", "inline-block"), f.each(function() {
                            if (t(this).hasClass("wpr-accordion-item-wrap")) {
                                var i = t(this); - 1 == i.text().toUpperCase().indexOf(e.toUpperCase()) ? (i.hide(), i.find(".wpr-acc-button").hasClass("wpr-acc-active") && i.find(".wpr-acc-panel").hasClass("wpr-acc-panel-active") && (i.find(".wpr-acc-button").removeClass("wpr-acc-active"), i.find(".wpr-acc-panel").removeClass("wpr-acc-panel-active"))) : (i.show(), !i.find(".wpr-acc-button").hasClass("wpr-acc-active") && !i.find(".wpr-acc-panel").hasClass("wpr-acc-panel-active") && (i.find(".wpr-acc-button").addClass("wpr-acc-active"), i.find(".wpr-acc-panel").addClass("wpr-acc-panel-active"), i.find(".wpr-acc-panel").slideDown(l)))
                            }
                        })) : (i.find(".wpr-acc-search-input-wrap").find("i.fa-times").css("display", "none"), f.each(function() {
            ...
            widgetImageScroll: function(e) {
                ...
                function i() {
                    ...
                    }), s.hasClass("wpr-trigger-hover") ? a() : s.hasClass("wpr-trigger-scroll") && r()
                }
                ...
                function r() {
                    function t() {
                        w ? n.css("transform", "translateY(-" + i + "px)") : n.css("transform", "translateX(-" + i + "px)"), a = !1
                    }
                    var i = m ? h : 0,
                        a = !1;
                ...
                const i = {
                        ...
                        if (console.log("Works", e), e && e.length) {
                            if (!this.apiLoaded && "undefined" == typeof YT) {
                                ...
                                t.parentNode.insertBefore(e, t), this.apiLoaded = !0, window.onYouTubeIframeAPIReady = () => {
                                    i.isAPIReady = !0, i.pendingPlayers.forEach(e => {
                    ...
                    processVideos: function(e, a) {
                        ...
                        Promise.all(n).then(a => {
                            const n = a.filter(e => null !== e).sort((e, t) => e.index - t.index);
                            n.forEach((a, n) => {
                                const o = t("<li>").attr("data-video", a.videoId),
                                    d = "https://i.ytimg.com/vi/" + a.videoId + "/maxresdefault.jpg";
                                o.append(t("<img>").attr({
                                    src: d,
                                    alt: a.title
                                }));
                                const l = t("<div>").addClass("wpr-vplaylist-info");
                                if (l.append(t("<" + s + ">").addClass("wpr-vplaylist-info-title").text(a.title)), o.append(l), r.append(o), 0 === n) {
                                    e.find(".wpr-vplaylist-current-title").text(a.title), e.find(".wpr-vplaylist-highlight").attr("data-video", a.videoId);
                                    const t = e.find(".wpr-vplaylist-main");
                                    i.isAPIReady ? i.createPlayer(t, a.videoId, e) : i.pendingPlayers.push({
                                        $container: t,
                                        videoId: a.videoId,
                                        $widget: e
                                    })
                                ...
                                i.players[r] && (i.players[r].loadVideoById(a), e.find(".wpr-vplaylist-highlight").attr("data-video", a), e.find(".wpr-vplaylist-current-title").text(s), e.find(".wpr-play").hide(), e.find(".wpr-pause").show())
                            })
                        })
                    },
            ...
            widgetProductAddToCart: function(i) {
                ...
                0 === n.length && (o = "last-child", d = "first-child"), e.editorCheck() && 0 < i.find("select").length && (i.find("select").on("change", function() {
                ...
                }), "default" !== s && a.find("input.qty").attr("type", "text").removeAttr("step").removeAttr("min").removeAttr("max"), i.off("click", "i:" + o).on("click", "i:" + o, function() {
                    var e = jQuery(this).prev(".quantity").find("input.qty");
                    0 === e.length && (e = jQuery(this).closest(".wpr-quantity-wrapper").find(".quantity").find("input.qty"));
                    var t = parseInt(e.val(), 10);
                    t < r && "both" == s ? (e.val(t + 1), i.find("input[name=\"update_cart\"]").removeAttr("disabled")) : t < r && "both" !== s && "default" !== s && (e.val(t + 1), i.find("input[name=\"update_cart\"]").removeAttr("disabled"))
                }), i.off("click", "i:" + d).on("click", "i:" + d, function() {
                    var e = jQuery(this).next(".quantity").find("input.qty");
                    0 === e.length && (e = jQuery(this).closest(".wpr-quantity-wrapper").find(".quantity").find("input.qty"));
                    var t = parseInt(e.val(), 10);
                    0 < t && "both" == s ? (e.val(t - 1), i.find("input[name=\"update_cart\"]").removeAttr("disabled")) : 0 < t && "both" !== s && "default" !== s && (e.val(t - 1), i.find("input[name=\"update_cart\"]").removeAttr("disabled"))
